...
def processa_aposentadoria(planilha_path):
    ...
    # Substitui os valores True/False por 'aposentável'/'não aposentável'
    df_servidores['aposentável'] = df_servidores['aposentável'].replace(
        {True: 'aposentável', False: 'não aposentável'})
...
# Processa a aposentadoria e salva o resultado em um novo arquivo Excel
resultado = processa_aposentadoria(arquivo_planilha)
resultado.to_excel('resultado_aposentadoria.xlsx', index=False)
